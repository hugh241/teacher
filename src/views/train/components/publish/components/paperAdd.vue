        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="所属课程" prop="courseId">
              <el-select style="width:100%" v-model="addForm.courseId" disabled placeholder="请选择所属课程" size="large">
                <el-option v-for="item in courseList" :label="item.label" :value="item.value" :key="item.value">{{
                  item.label }}</el-option>
              </el-select>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="所属章节" prop="chapterId">
              <el-select style="width:100%" v-model="addForm.chapterId" placeholder="请选择所属章节" size="large">
                <el-option v-for="item in chapterList" :label="item.label" :value="item.value" :key="item.value">{{
                  item.label }}</el-option>
              </el-select>
            </el-form-item>
          </el-col>
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="开始时间" prop="startTime">
              <el-date-picker type="date" placeholder="请选择开始时间" v-model="addForm.startTime" @change="startTimeChange"
                format="yyyy-MM-dd" size="large" style="width: 100%" :picker-options="{
                  disabledDate: time => {
          ...
          <el-col :span="12">
            <el-form-item label="结束时间" prop="endTime">
              <el-date-picker type="date" placeholder="请选择结束时间" v-model="addForm.endTime" @change="endTimeChange"
                format="yyyy-MM-dd" size="large" style="width: 100%" :picker-options="{
                  disabledDate: time => {
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="试卷总分" prop="totalScore">
              <el-input type="number" min="0" placeholder="请输入试卷总分" v-model="addForm.totalScore" size="large"
                style="width: 100%">
              </el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="及格分数" prop="passScore">
              <el-input type="number" min="0" placeholder="请输入及格分数" v-model="addForm.passScore" size="large"
                style="width: 100%">
              </el-input>
            </el-form-item>
          </el-col>
  ...
  data() {
    return {
      ...
      formRules: {
        ...
        passScore: [
          { required: true, message: '请填写及格分数', trigger: 'blur' },
        ],
        state: [
      ...
      dataTime: {
        ...
        // 结束时间设置
        endTimeData: time => {
          return time.getTime() <= new Date(this.addForm.startTime).valueOf() - 8.64e7
        },
      },
      optionsEndTime: {
        // 结束时间不能小于开始时间
